        ...
        : <div>
            ...
            <div className=" container company">
                ...
                <div className="des-and-video" >
                    <div className="video" >
                        <img src={"/images/company/" + videourl} alt="company" className="ima" />
                    </div>
                    <div className="des">
                        <h3>{name}</h3>
                        {companydes}
                        ...
                        employer.map((el, index) =>
                            <div className="team-iner" key={index}>
                                <div className="team-photo">
                                    <div className="be-image" style={{ backgroundImage: `url(${"/images/employer/" + el.imageUrl})`,backgroundSize:"100% 100%" }}>
                                    </div>
                                </div>
